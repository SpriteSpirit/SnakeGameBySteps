...
pygame.draw.rect(sr, White, (20, 20, 50, 100)) # палитра RGB (255, 255, 255) - цвет белый, (x=20, y=20 - координаты, x=50, y=100 - размеры) - отрисует белый прямоугольник
pygame.draw.line(sr, Red, (20, 20), (70, 20), 5) # ((20, 20) - начальная позиция, (70, 20) - конечная позиция, 5 - толщина) - отрисует красную линию
pygame.draw.aaline(sr, Lime, (30, 25), (30, 120)) # ((20, 20) - начальная позиция, (70, 20) - конечная позиция, 5 - толщина) - отрисует зеленую. линию
pygame.draw.polygon(sr, Blue, [[100, 100], [0, 200], [200, 200]], 5) # синий треугольник
pygame.draw.circle(sr, "Pink", [60, 250], 40)

# отрисовываем то, что наложили на поверхность
