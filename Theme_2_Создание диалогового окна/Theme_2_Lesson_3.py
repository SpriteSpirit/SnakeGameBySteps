...
pygame.display.set_mode((WIDTH, HEIGHT)) # set_mode(size=00, flags=0, depth=0, display=0, vsync=0) - какие параметры принимает функция (мы указали только размер экрана)
